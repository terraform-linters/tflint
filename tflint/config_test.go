...
plugin "baz" {
	...
	foo = "baz"
			...
			want: &Config{
				...
				PluginDirSet:          true,
				PluginReleaseCache:    ".plugin-release-cache.json",
				PluginReleaseCacheSet: true,
				PluginReduceGhAPI:     true,
				PluginReduceGhAPISet:  true,
				Format:                "compact",
				FormatSet:             true,
	...
	tests := []struct {
		...
		},
		{
			...
			base: &Config{
				...
				PluginDir:             "./.tflint.d/plugins",
				PluginDirSet:          true,
				PluginReleaseCache:    "~/.tflint.d/.plugin-release-cache.json",
				PluginReleaseCacheSet: true,
				PluginReduceGhAPI:     true,
				PluginReduceGhAPISet:  true,
				Format:                "compact",
