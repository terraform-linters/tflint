...
func NewAwsConfigConfigurationRecorderInvalidNameRule() *AwsConfigConfigurationRecorderInvalidNameRule {
	return &AwsConfigConfigurationRecorderInvalidNameRule{
...
func (r *AwsConfigConfigurationRecorderInvalidNameRule) Name() string {
	return "aws_config_configuration_recorder_invalid_name"
}
...
func (r *AwsConfigConfigurationRecorderInvalidNameRule) Type() string {
	return issue.ERROR
}
