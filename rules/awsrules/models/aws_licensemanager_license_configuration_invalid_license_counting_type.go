...
func NewAwsLicensemanagerLicenseConfigurationInvalidLicenseCountingTypeRule() *AwsLicensemanagerLicenseConfigurationInvalidLicenseCountingTypeRule {
	return &AwsLicensemanagerLicenseConfigurationInvalidLicenseCountingTypeRule{
...
func (r *AwsLicensemanagerLicenseConfigurationInvalidLicenseCountingTypeRule) Name() string {
	return "aws_licensemanager_license_configuration_invalid_license_counting_type"
}
...
func (r *AwsLicensemanagerLicenseConfigurationInvalidLicenseCountingTypeRule) Type() string {
	return issue.ERROR
}
	...
	return runner.WalkResourceAttributes(r.resourceType, r.attributeName, func(attribute *hcl.Attribute) error {
		...
		return runner.EnsureNoError(err, func() error {
			...
			if !found {
				runner.EmitIssue(
					r,
					`license_counting_type is not a valid value`,
