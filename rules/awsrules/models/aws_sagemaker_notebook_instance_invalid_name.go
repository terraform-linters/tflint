...
func NewAwsSagemakerNotebookInstanceInvalidNameRule() *AwsSagemakerNotebookInstanceInvalidNameRule {
	return &AwsSagemakerNotebookInstanceInvalidNameRule{
...
func (r *AwsSagemakerNotebookInstanceInvalidNameRule) Name() string {
	return "aws_sagemaker_notebook_instance_invalid_name"
}
...
func (r *AwsSagemakerNotebookInstanceInvalidNameRule) Type() string {
	return issue.ERROR
}
