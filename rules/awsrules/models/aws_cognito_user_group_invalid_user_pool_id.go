...
func NewAwsCognitoUserGroupInvalidUserPoolIDRule() *AwsCognitoUserGroupInvalidUserPoolIDRule {
	return &AwsCognitoUserGroupInvalidUserPoolIDRule{
...
func (r *AwsCognitoUserGroupInvalidUserPoolIDRule) Name() string {
	return "aws_cognito_user_group_invalid_user_pool_id"
}
...
func (r *AwsCognitoUserGroupInvalidUserPoolIDRule) Type() string {
	return issue.ERROR
}
