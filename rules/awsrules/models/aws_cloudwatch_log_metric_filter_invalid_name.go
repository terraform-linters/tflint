...
func NewAwsCloudwatchLogMetricFilterInvalidNameRule() *AwsCloudwatchLogMetricFilterInvalidNameRule {
	return &AwsCloudwatchLogMetricFilterInvalidNameRule{
...
func (r *AwsCloudwatchLogMetricFilterInvalidNameRule) Name() string {
	return "aws_cloudwatch_log_metric_filter_invalid_name"
}
...
func (r *AwsCloudwatchLogMetricFilterInvalidNameRule) Type() string {
	return issue.ERROR
}
