...
func NewAwsElastictranscoderPipelineInvalidNameRule() *AwsElastictranscoderPipelineInvalidNameRule {
	return &AwsElastictranscoderPipelineInvalidNameRule{
...
func (r *AwsElastictranscoderPipelineInvalidNameRule) Name() string {
	return "aws_elastictranscoder_pipeline_invalid_name"
}
...
func (r *AwsElastictranscoderPipelineInvalidNameRule) Type() string {
	return issue.ERROR
}
