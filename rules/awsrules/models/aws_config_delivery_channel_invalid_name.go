...
func NewAwsConfigDeliveryChannelInvalidNameRule() *AwsConfigDeliveryChannelInvalidNameRule {
	return &AwsConfigDeliveryChannelInvalidNameRule{
...
func (r *AwsConfigDeliveryChannelInvalidNameRule) Name() string {
	return "aws_config_delivery_channel_invalid_name"
}
...
func (r *AwsConfigDeliveryChannelInvalidNameRule) Type() string {
	return issue.ERROR
}
