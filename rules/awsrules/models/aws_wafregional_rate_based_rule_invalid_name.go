...
func NewAwsWafregionalRateBasedRuleInvalidNameRule() *AwsWafregionalRateBasedRuleInvalidNameRule {
	return &AwsWafregionalRateBasedRuleInvalidNameRule{
...
func (r *AwsWafregionalRateBasedRuleInvalidNameRule) Name() string {
	return "aws_wafregional_rate_based_rule_invalid_name"
}
...
func (r *AwsWafregionalRateBasedRuleInvalidNameRule) Type() string {
	return issue.ERROR
}
