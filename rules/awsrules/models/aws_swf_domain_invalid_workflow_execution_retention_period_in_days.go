...
func NewAwsSwfDomainInvalidWorkflowExecutionRetentionPeriodInDaysRule() *AwsSwfDomainInvalidWorkflowExecutionRetentionPeriodInDaysRule {
	return &AwsSwfDomainInvalidWorkflowExecutionRetentionPeriodInDaysRule{
		resourceType:  "aws_swf_domain",
		attributeName: "workflow_execution_retention_period_in_days",
		max:           8,
		min:           1,
	}
}
...
func (r *AwsSwfDomainInvalidWorkflowExecutionRetentionPeriodInDaysRule) Name() string {
	return "aws_swf_domain_invalid_workflow_execution_retention_period_in_days"
}
...
func (r *AwsSwfDomainInvalidWorkflowExecutionRetentionPeriodInDaysRule) Type() string {
	return issue.ERROR
}
	...
	return runner.WalkResourceAttributes(r.resourceType, r.attributeName, func(attribute *hcl.Attribute) error {
		...
		return runner.EnsureNoError(err, func() error {
			if len(val) > r.max {
				runner.EmitIssue(
					r,
					"workflow_execution_retention_period_in_days must be 8 characters or less",
			...
			if len(val) < r.min {
				runner.EmitIssue(
					r,
					"workflow_execution_retention_period_in_days must be 1 characters or higher",
					attribute.Expr.Range(),
				)
			}
			return nil
