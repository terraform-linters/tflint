...
func NewAwsWafregionalRegexMatchSetInvalidNameRule() *AwsWafregionalRegexMatchSetInvalidNameRule {
	return &AwsWafregionalRegexMatchSetInvalidNameRule{
...
func (r *AwsWafregionalRegexMatchSetInvalidNameRule) Name() string {
	return "aws_wafregional_regex_match_set_invalid_name"
}
...
func (r *AwsWafregionalRegexMatchSetInvalidNameRule) Type() string {
	return issue.ERROR
}
