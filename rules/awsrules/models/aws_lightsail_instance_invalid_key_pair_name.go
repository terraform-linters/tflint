...
func NewAwsLightsailInstanceInvalidKeyPairNameRule() *AwsLightsailInstanceInvalidKeyPairNameRule {
	return &AwsLightsailInstanceInvalidKeyPairNameRule{
		resourceType:  "aws_lightsail_instance",
		attributeName: "key_pair_name",
...
func (r *AwsLightsailInstanceInvalidKeyPairNameRule) Name() string {
	return "aws_lightsail_instance_invalid_key_pair_name"
}
...
func (r *AwsLightsailInstanceInvalidKeyPairNameRule) Type() string {
	return issue.ERROR
}
	...
	return runner.WalkResourceAttributes(r.resourceType, r.attributeName, func(attribute *hcl.Attribute) error {
		...
		return runner.EnsureNoError(err, func() error {
			if !r.pattern.MatchString(val) {
				runner.EmitIssue(
					r,
					`key_pair_name does not match valid pattern ^\w[\w\-]*\w$`,
