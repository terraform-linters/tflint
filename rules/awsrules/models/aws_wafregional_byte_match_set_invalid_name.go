...
func NewAwsWafregionalByteMatchSetInvalidNameRule() *AwsWafregionalByteMatchSetInvalidNameRule {
	return &AwsWafregionalByteMatchSetInvalidNameRule{
...
func (r *AwsWafregionalByteMatchSetInvalidNameRule) Name() string {
	return "aws_wafregional_byte_match_set_invalid_name"
}
...
func (r *AwsWafregionalByteMatchSetInvalidNameRule) Type() string {
	return issue.ERROR
}
