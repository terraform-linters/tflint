...
func NewAwsWafregionalWebACLAssociationInvalidResourceArnRule() *AwsWafregionalWebACLAssociationInvalidResourceArnRule {
	return &AwsWafregionalWebACLAssociationInvalidResourceArnRule{
...
func (r *AwsWafregionalWebACLAssociationInvalidResourceArnRule) Name() string {
	return "aws_wafregional_web_acl_association_invalid_resource_arn"
}
...
func (r *AwsWafregionalWebACLAssociationInvalidResourceArnRule) Type() string {
	return issue.ERROR
}
	...
	return runner.WalkResourceAttributes(r.resourceType, r.attributeName, func(attribute *hcl.Attribute) error {
		...
		return runner.EnsureNoError(err, func() error {
			if len(val) > r.max {
				runner.EmitIssue(
					r,
					"resource_arn must be 1224 characters or less",
